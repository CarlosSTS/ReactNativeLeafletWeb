...
export interface BaseMarker {
    ...
    title?: string;
    /** Secondary text displayed below the title inside the tooltip. */
    description?: string;
    /** Inline CSS styles applied to the marker icon element. */
    iconStyle?: string;
    /** Inline CSS styles applied to the tooltip title text. */
    titleStyle?: string;
    /** Inline CSS styles applied to the tooltip description text. */
    ...
    /** Inline CSS styles applied to the close button container (wrapper div). */
    ...
    autoClose?: boolean;
    /** Opens the tooltip immediately when the marker is added to the map. @default false */
    openPopupOnAdd?: boolean;
    /** Pixel offset `[x, y]` of the popup from the marker anchor point. @default [0, -5] */
    popupOffset?: [number, number];
    /** Maximum width of the popup in pixels. @default 300 */
    popupMaxWidth?: number;
    /** Minimum width of the popup in pixels. @default 50 */
    popupMinWidth?: number;
    /** Whether the map auto-pans to fit the popup when it opens. @default true */
    autoPan?: boolean;
    /** Keeps the popup in view when the user pans the map. @default false */
    keepInView?: boolean;
    /** Closes the popup when the user presses the Escape key. @default true */
